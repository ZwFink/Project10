...
//    {
//        GenericHashClass<Integer> ghc = new GenericHashClass<>(5, 1, GenericHashClass.QUADRATIC_PROBING );
//
//        ghc.addItem(3);
//        ghc.addItem(5);
//        ghc.addItem(5);
...
public class GenericHashClassMain
{
    ...
    private static int probeSetting = GenericHashClass.QUADRATIC_PROBING;
    ...
    public static void main(String[] args)
    {
        ...
        testClass = uploadData( "src/p10_Package/inData.txt" );
